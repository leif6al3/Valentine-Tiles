...
export default function TextFooter() {
  return (
    <>
      ...
      >
        <span className="text-gray-400">Match</span> <br /> the photo pairs c;
      </h1>
      ...
      >
        to reveal <br /> <span className="text-gray-400">the surprise hihi</span>
      </h1>

      {/* Copyright */}
      <p className="absolute bottom-5 right-5 text-white text-sm opacity-15 hover:opacity-50">
        © {new Date().getFullYear()}{" "}
        <Link href="https://iloveyoutrisha.com">iloveyoutrisha.com</Link>
      </p>
    </>
  );
}
